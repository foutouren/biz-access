...
import com.glsx.biz.common.core.entity.BaseEntity;
import com.glsx.cloudframework.core.datastructure.page.Pagination;
import com.glsx.cloudframework.core.util.BeanUtils;
import com.glsx.cloudframework.core.util.ReflectionUtil;
import com.glsx.cloudframework.persistent.types.*;
...
public class HibernateBaseDAO {
	...
	public Serializable save(Object entity) throws HibernateException {
		...
		ReflectionUtil.invokeSetterMethod(entity, BaseEntity.CREATE_TIME_PROPERTY_NAME, new Date());
	...
	public void update(Object entity) throws HibernateException {
		Assert.notNull(entity);
		ReflectionUtil.invokeSetterMethod(entity, BaseEntity.UPDATE_TIME_PROPERTY_NAME, new Date());
	...
	public void saveOrUpdate(Collection<Object> objList) throws HibernateException {
		...
		for (Object object : objList) {
			ReflectionUtil.invokeSetterMethod(object, BaseEntity.CREATE_TIME_PROPERTY_NAME, new Date());
			ReflectionUtil.invokeSetterMethod(object, BaseEntity.CREATE_TIME_PROPERTY_NAME, new Date());
